...
<br>
.font140[
- Long time aspiration to contribute in bringing more empirical rigor to policy discussions
  - Admire academic pursuit of rigor and global scope of the endevour
...
<br>
.font140[
- In one word: which area do you work on? (e.g. health, poverty, labor, energy, etc.)
- What policy issue has occupied most of your time lately? (e.g identifying vulnerable populations, 
providing essential goods or services, building infraestructure, etc.)
- What type of analysis did you used, or would have liked to use, to inform the previous policy issue (e.g. geografical estimates of poverty, accurate costs of provision of goods and services, context relevan cost-benefits analysis)
]
---
class: inverse, center, middle
name: framework
